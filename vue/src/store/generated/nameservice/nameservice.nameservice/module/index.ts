...
import { MsgByName } from "./types/nameservice/tx";


const types = [
  ["/nameservice.nameservice.MsgSetName", MsgSetName],
  ["/nameservice.nameservice.MsgByName", MsgByName],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgByName: (data: MsgByName): EncodeObject => ({ typeUrl: "/nameservice.nameservice.MsgByName", value: MsgByName.fromPartial( data ) }),
